...
import 'package:farmfusion_app/pages/succesfully.dart';
...
class _CreateAccountState extends State<CreateAccount> {
    ...
    return Container(
      decoration: BoxDecoration(
        ...
        image: DecorationImage(
          image: const AssetImage("assets/images/postingan.jpg"),
          fit: BoxFit.cover,
          colorFilter:
  ...
  Widget _buildTop() {
    return SizedBox(
      ...
      child: Column(
        ...
        children: [
          Image.asset("assets/images/logo_apk.png", width: 100, height: 100),
          const Text(
            "FarmFusion",
            style: TextStyle(
                color: Colors.white,
    ...
    return Column(
      ...
      children: [
        const Text(
          "Welcome",
          style: TextStyle(
              color: Constants.secondaryColor, fontSize: 32, fontWeight: FontWeight.w500),
        ),
  ...
  Widget _buildCreateAccountButton() {
    return ElevatedButton(
      onPressed: () {
        Navigator.push(context, MaterialPageRoute(builder: (context) => const SuccesfullyScreen()));
      },
