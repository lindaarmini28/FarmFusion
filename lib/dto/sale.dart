...
class Post {
  int? id;
  File? image; // Menggunakan tipe data File untuk gambar
  String type;
  String title;
  String location;
  String quantity;
  ...
  Post({
    this.id,
    this.image, // Memperbarui tipe data menjadi File
    required this.type,
    required this.title,
  ...
  factory Post.fromMap(Map<String, dynamic> map) {
    return Post(
      id: map['id'],
      image: map['image'], // Memperbarui inisialisasi gambar
      type: map['type'],
      title: map['title'],
  ...
  Map<String, dynamic> toMap() {
    return {
      'id': id,
      'image': image!.path, // Memperbarui konversi gambar menjadi path file
      'type': type,
      'title': title,
      'location': location,
      'quantity': quantity,
